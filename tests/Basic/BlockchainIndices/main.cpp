...
// PaymentIdIndex
// add()
TEST(blockchainIndices_PaymentIdIndex, 1)
{
...
// PaymentIdIndex
// find()
TEST(blockchainIndices_PaymentIdIndex, 2)
{
  PaymentIdIndex paymentIdIndex;
...
// PaymentIdIndex
// remove()
TEST(blockchainIndices_PaymentIdIndex, 3)
{
  PaymentIdIndex paymentIdIndex;
...
// PaymentIdIndex
// clear()
TEST(blockchainIndices_PaymentIdIndex, 4)
{
  PaymentIdIndex paymentIdIndex;
...
TEST(blockchainIndices_TimestampBlocksIndex, 1)
{
...
// max timestamp
// hash of all zeros
TEST(blockchainIndices_TimestampBlocksIndex, 2)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// max timestamp
// hash of all 255
TEST(blockchainIndices_TimestampBlocksIndex, 3)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// timestamp equals 0
// hash of all zeros
TEST(blockchainIndices_TimestampBlocksIndex, 4)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// timestamp equals 0
// hash of all 255
TEST(blockchainIndices_TimestampBlocksIndex, 5)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 6)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
TEST(blockchainIndices_TimestampBlocksIndex, 7)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 8)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 9)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampBlocksIndex, 10)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 11)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 12)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 13)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 14)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
TEST(blockchainIndices_TimestampBlocksIndex, 15)
{
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 16)
{
  // same test for timestamp collision
}
...
TEST(blockchainIndices_TimestampBlocksIndex, 17)
{
...
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 18)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 19)
{
  // same test for timestamp collision
}
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampBlocksIndex, 20)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 21)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 22)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 23)
{
  Crypto::Hash hash;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 24)
{
  Crypto::Hash hash;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampBlocksIndex, 25)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 26)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 27)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 28)
{
  Crypto::Hash hash;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 29)
{
  Crypto::Hash hash;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampBlocksIndex, 30)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 31)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 32)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 33)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 34)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
TEST(blockchainIndices_TimestampBlocksIndex, 35)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampBlocksIndex, 36)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 37)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 38)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 39)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 40)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// find()
// hashesNumberLimit > hashesNumberWithinTimestamps
TEST(blockchainIndices_TimestampBlocksIndex, 41)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampBlocksIndex, 42)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// max timestamp
// hash of all zeros
TEST(blockchainIndices_TimestampBlocksIndex, 43)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// max timestamp
// hash of all 255
TEST(blockchainIndices_TimestampBlocksIndex, 44)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// hash of all zeros
TEST(blockchainIndices_TimestampBlocksIndex, 45)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// timestamp equals zero
// hash of all 255
TEST(blockchainIndices_TimestampBlocksIndex, 46)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 47)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 48)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampBlocksIndex, 49)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampBlocksIndex, 50)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
// remove() fail
// no entries added
TEST(blockchainIndices_TimestampBlocksIndex, 51)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
// remove() fail
// timestamp mismatch
TEST(blockchainIndices_TimestampBlocksIndex, 52)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
// remove() fail
// hash mismatch
TEST(blockchainIndices_TimestampBlocksIndex, 53)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
TEST(blockchainIndices_TimestampBlocksIndex, 54)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
// TimestampBlocksIndex
// clear()
TEST(blockchainIndices_TimestampBlocksIndex, 55)
{
  TimestampBlocksIndex timestampBlocksIndex;
...
TEST(blockchainIndices_TimestampBlocksIndex, 56)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampBlocksIndex timestampBlocksIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 1)
{
...
// max timestamp
// hash of all zeros
TEST(blockchainIndices_TimestampTransactionsIndex, 2)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// max timestamp
// hash of all 255
TEST(blockchainIndices_TimestampTransactionsIndex, 3)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// timestamp equals 0
// hash of all zeros
TEST(blockchainIndices_TimestampTransactionsIndex, 4)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// timestamp equals 0
// hash of all 255
TEST(blockchainIndices_TimestampTransactionsIndex, 5)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 6)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 7)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 8)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 9)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 10)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 11)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 12)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 13)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 14)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
TEST(blockchainIndices_TimestampTransactionsIndex, 15)
{
  // same test for timestamp collision
}
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 16)
{
  // same test for timestamp collision
}
...
// single random timestamp
// multiple random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 17)
{
  // same as for timestamp collision
}
...
// multiple random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 18)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 19)
{
  // same test for timestamp collision
}
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 20)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 21)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 22)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 23)
{
  Crypto::Hash hash;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 24)
{
  Crypto::Hash hash;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 25)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 26)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 27)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 28)
{
  Crypto::Hash hash;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 29)
{
  Crypto::Hash hash;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 30)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 31)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 32)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 33)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 34)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// hashesNumberLimit equals 0
// random timestamp random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 35)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 36)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 37)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 38)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 39)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 40)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// find()
// hashesNumberLimit > hashesNumberWithinTimestamps
TEST(blockchainIndices_TimestampTransactionsIndex, 41)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single constant timestamp
// single constant hash
TEST(blockchainIndices_TimestampTransactionsIndex, 42)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// max timestamp
// hash of all zeros
TEST(blockchainIndices_TimestampTransactionsIndex, 43)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// max timestamp
// hash of all 255
TEST(blockchainIndices_TimestampTransactionsIndex, 44)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// timestamp equals zero
// hash of all zeros
TEST(blockchainIndices_TimestampTransactionsIndex, 45)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// timestamp equals zero
// hash of all 255
TEST(blockchainIndices_TimestampTransactionsIndex, 46)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 47)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// single random timestamp
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 48)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// single random hash
TEST(blockchainIndices_TimestampTransactionsIndex, 49)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// multiple random timestamps
// multiple random hashes
TEST(blockchainIndices_TimestampTransactionsIndex, 50)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// remove() fail
// no entries added
TEST(blockchainIndices_TimestampTransactionsIndex, 51)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// remove() fail
// timestamp mismatch
TEST(blockchainIndices_TimestampTransactionsIndex, 52)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// remove() fail
// hash mismatch
TEST(blockchainIndices_TimestampTransactionsIndex, 53)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// remove() fail
// timestamp mismatch and hash mismatch
TEST(blockchainIndices_TimestampTransactionsIndex, 54)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// TimestampTransactionsIndex
// clear()
TEST(blockchainIndices_TimestampTransactionsIndex, 55)
{
  TimestampTransactionsIndex timestampTransactionsIndex;
...
// clear()
// no entries previously added
TEST(blockchainIndices_TimestampTransactionsIndex, 56)
{
  for (int i = 0; i < loopCount; ++i)
  {
    TimestampTransactionsIndex timestampTransactionsIndex;
...
// add() success
TEST(blockchainIndices_GeneratedTransactionsIndex, 1)
{
...
TEST(blockchainIndices_GeneratedTransactionsIndex, 2)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// add()fail
// add empty block
TEST(blockchainIndices_GeneratedTransactionsIndex, 3)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
TEST(blockchainIndices_GeneratedTransactionsIndex, 4)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
TEST(blockchainIndices_GeneratedTransactionsIndex, 5)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// GeneratedTransactionsIndex
// find() success 1
TEST(blockchainIndices_GeneratedTransactionsIndex, 6)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// GeneratedTransactionsIndex
// find() success 2
TEST(blockchainIndices_GeneratedTransactionsIndex, 7)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
TEST(blockchainIndices_GeneratedTransactionsIndex, 8)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
TEST(blockchainIndices_GeneratedTransactionsIndex, 9)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// GeneratedTransactionsIndex
// remove() success
TEST(blockchainIndices_GeneratedTransactionsIndex, 10)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// GeneratedTransactionsIndex
// remove() success
TEST(blockchainIndices_GeneratedTransactionsIndex, 11)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// remove() fail
// remove empty block
TEST(blockchainIndices_GeneratedTransactionsIndex, 12)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// GeneratedTransactionsIndex
// clear()
TEST(blockchainIndices_GeneratedTransactionsIndex, 13)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// GeneratedTransactionsIndex
// clear()
TEST(blockchainIndices_GeneratedTransactionsIndex, 14)
{
  GeneratedTransactionsIndex generatedTransactionsIndex;
...
// OrphanBlocksIndex
// add() success
TEST(blockchainIndices_OrphanBlocksIndex, 1)
{
...
TEST(blockchainIndices_OrphanBlocksIndex, 2)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
TEST(blockchainIndices_OrphanBlocksIndex, 3)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
// OrphanBlocksIndex
// find() success
TEST(blockchainIndices_OrphanBlocksIndex, 4)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
TEST(blockchainIndices_OrphanBlocksIndex, 5)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
// OrphanBlocksIndex
// remove() success
TEST(blockchainIndices_OrphanBlocksIndex, 6)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
TEST(blockchainIndices_OrphanBlocksIndex, 7)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
// OrphanBlocksIndex
// clear() success
TEST(blockchainIndices_OrphanBlocksIndex, 8)
{
  OrphanBlocksIndex orphanBlocksIndex;
...
TEST(blockchainIndices_OrphanBlocksIndex, 9)
{
  OrphanBlocksIndex orphanBlocksIndex;
