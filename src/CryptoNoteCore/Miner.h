...
namespace CryptoNote {
  ...
  public:
    ...
    static bool find_nonce_for_given_block1(Crypto::cn_context &context, Block& bl, const difficulty_type& diffic);
    static bool find_nonce_for_given_block2(Crypto::cn_context &context, Block& bl, const difficulty_type& diffic);
    void pause();
    void resume();
