...
const uint64_t HARD_FORK_HEIGHT_3                            = 10000;
...
const int      P2P_DEFAULT_PORT                              = 13275;
const int      RPC_DEFAULT_PORT                              = 13276;
const int      WALLETD_DEFAULT_PORT                          = 13277;
